...
public class number_of_agents {
    ...
    public int solution(int k, int n, int[][] reqs) {
        ...
        while (remainCounselorNumber-- > 0) {
            ...
            for (int type = 1; type < k + 1; type++) {
                int currentCounselorByType = currentCounselors[type];
                int waitingTimeOfCurrentCounselors = waitTimeForEachTime[type][currentCounselorByType];
                int next = waitTimeForEachTime[type][currentCounselorByType + 1];
